        ...
        <div class="container">
            ...
            <form action="" method="get" class="d-flex ">
                <div class="input-group">
                    <input type="text" name="search" placeholder="Seacher Product " class="form-control" size="70" >
                    <input type="submit" name="find" value="Go" class="btn btn-danger border-0 rounded-0">
                </div>
            </form>
            <ul class="navbar-nav">
